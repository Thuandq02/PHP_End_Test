                        ...
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav">
                                <ul>
                                    ...
                                    <li>
                                        <a href="index.php?page=list_product">Manage</a>
                                    </li>
                ...
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <input type="checkbox" class="common_selector brand" value="<?php echo $value->getId(); ?>">  <?php echo $value->getColor(); ?>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="list-group">
                            <div class="list-group-item">
                                <select name="category" id="" size="9" multiple>
                                    ...
                                    <option value="<?php echo $value->getId(); ?>" style="width: 200px; padding: 6px 12px"><?php echo $value->getCategory(); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="product_grid">
                        ...
                        <?php foreach ($products as $key => $value): ?>
                            <div class="product">
                                <div class="product_image"><img src="img/<?php echo $value->getImage(); ?>" alt=""
                                                                style="width: 210px;height: 210px"></div>
                                <div class="product_extra product_new"><a href="#">New</a></div>
                                <div class="product_content">
                                    <div class="product_title"><a href="#"><?php echo $value->getName(); ?></a></div>
                                    <div class="product_price"><?php echo number_format($value->getPrice()) ?> đ</div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
